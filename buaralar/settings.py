"""
Django settings for buaralar project.
...
SECRET_KEY = '#0g7=vli%g7866!n$771%da)4#yrfld9!@p0@4m3shu(lulk=%'
...
ROOT_URLCONF = 'buaralar.urls'

WSGI_APPLICATION = 'buaralar.wsgi.application'
...
THUMBNAIL_ALIASES = {
    '': {
        'post_image_small': {'size': (262,33), 'crop': True},
