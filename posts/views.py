...
def index(request):
    ...
    img_thumb = get_thumb_name(selected_event.image.url)

    context = {'latest_event_list': latest_event_list, 'third_day': third_day, 'this_year': this_year, 'selected_event': selected_event, 'img_thumb': img_thumb, 'selected_day': 'today'}
...
def posts_views_get_selected_event_ajax(request, post_id):
    ...
    return render_to_response('posts/detail.html', {'selected_event': selected_event, 'img_thumb': img_thumb }, context)
...
def posts_views_get_selected_event(request, post_id):
    ...
    context = {'latest_event_list': latest_event_list, 'third_day': third_day, 'this_year': this_year, 'selected_event': selected_event, 'img_thumb': img_thumb, 'selected_day': event_day}
    return render(request, 'posts/index.html', context)
